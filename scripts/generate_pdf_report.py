#!/usr/bin/env python3
"""
Marketing Report PDF Generator — AI Marketing Codex Skills
Generates professional, client-ready PDF marketing reports with charts,
score visualizations, and prioritized action plans.

Requires: reportlab (run with: uv run --with reportlab python scripts/generate_pdf_report.py)
"""
...
try:
    ...
    print("Error: reportlab is required. Run with: uv run --with reportlab python scripts/generate_pdf_report.py")
    sys.exit(1)
...
def generate_report(data, output_path):
    ...
    elements.append(Spacer(1, 0.5 * inch))
    elements.append(Paragraph(
        "Generated by AI Marketing Suite for Codex",
